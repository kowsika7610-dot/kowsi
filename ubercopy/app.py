...
# 🔥 GET DATABASE URL
db_url = os.getenv("mysql://root:xCKEvEQdQLVrMECracJBpsDjWEXIGskE@interchange.proxy.rlwy.net:14962/railway")
 
# 👉 fallback for local testing (IMPORTANT)
if not db_url:
    db_url = "mysql://root:xCKEvEQdQLVrMECracJBpsDjWEXIGskE@interchange.proxy.rlwy.net:14962/railway"
